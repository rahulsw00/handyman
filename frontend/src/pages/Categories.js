...
function Categories() {
    ...
    var categoryElement = (react_1.default.createElement("div", { className: "flex flex-wrap justify-center" }, Category.map(function (category, categoryIndex) { return (react_1.default.createElement("div", { key: categoryIndex, className: "card bg-white shadow-md rounded-lg p-6 m-4 w-80" },
        react_1.default.createElement("h3", null,
            react_1.default.createElement("b", null, category)),
        react_1.default.createElement("ul", null, SubCat[categoryIndex].map(function (subCategory, index) { return (react_1.default.createElement("li", { key: index }, subCategory)); })))); })));
    return (react_1.default.createElement("div", { className: "flex items-center justify-center" }, categoryElement));
}
